...
const Paragraph = sequelize.define(
  'Paragraph',
  {
    ...
    num: { type: DataTypes.INTEGER, allowNull: false }, // 第几段
...
const content = `●一百年来，党领导文艺战线不断探索、实践，走出了一条以马克思主义为指导、符合中国国情和文化传统、高扬人民性的文艺发展道路，为我国文艺繁荣发展指明了前进方向。实践充分证明，文艺事业是党和人民的重要事业，文艺战线是党和人民的重要战线，广大文艺工作者无愧于党和人民的期待与要求
  ...
  新华社北京12月14日电 中国文学艺术界联合会第十一次全国代表大会、中国作家协会第十次全国代表大会14日上午在北京人民大会堂开幕。中共中央总书记、国家主席、中央军委主席习近平出席大会并发表重要讲话强调，一百年来，党领导文艺战线不断探索、实践，走出了一条以马克思主义为指导、符合中国国情和文化传统、高扬人民性的文艺发展道路，为我国文艺繁荣发展指明了前进方向。实践充分证明，文艺事业是党和人民的重要事业，文艺战线是党和人民的重要战线，广大文艺工作者无愧于党和人民的期待与要求。（讲话全文见第二版）
...
// 测试文档表结构
(async () => {
  await sequelize.sync({ alter: true }); // 检查数据库中表的当前状态(它具有哪些列,它们的数据类型等),然后在表中进行必要的更改以使其与模型匹配
  const paper = await Document.create({
    title: '增强文化自觉坚定文化自信展示中国文艺新气象铸就中华文化新辉煌',
    paraLength: 20,
  });
